...
- [x] **Phase 21: LLM Behavioral & Judge** - LLM tool selection accuracy, disambiguation, output interpretation, and judge scoring (completed 2026-04-12)
...
Plans:
- [x] 21-01-PLAN.md — Shared LLM infrastructure + tool selection and disambiguation tests
- [x] 21-02-PLAN.md — Output interpretation tests + judge scoring infrastructure
