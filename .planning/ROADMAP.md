...
Plans:
- [ ] 56-01-PLAN.md — Restructure ProcessHandle.Start lifecycle + add StartListen(ctx) + process_test.go (D-02, D-03)
- [ ] 56-02-PLAN.md — Wire dispatcher + regression assertion in Worker.Start + worker_test.go + extend codec_test.go (D-01, D-04, D-05, D-11, D-12)
- [ ] 56-03-PLAN.md — Implement JdtlsAdapter.NotificationHandlers + WaitUntilJavaReady + extend quirks_test.go (D-06, D-07, D-08, D-09, D-13)
