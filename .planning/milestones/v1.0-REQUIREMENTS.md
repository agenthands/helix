...
- [x] **DGN-01**: Server reports LSP diagnostics after edits (errors, warnings)
- [x] **DGN-02**: User can request code actions / quick fixes from LSP
- [x] **DGN-03**: User can format code via LSP on demand
...
| DGN-01 | Phase 2 (wiring: Phase 5) | Complete |
| DGN-02 | Phase 2 (wiring: Phase 5) | Complete |
| DGN-03 | Phase 2 (wiring: Phase 5) | Complete |
