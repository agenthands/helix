...
- [ ] 86-03-PLAN.md — CrossCodeEval dataset-loader-only adapter: net/http + arrow-go parquet fetch, SSRF/path-safe leaf, py/java/ts/csharp fixtures; pinned-rev + arrow-go legitimacy checkpoints (ADAPTER-CCE-01)
