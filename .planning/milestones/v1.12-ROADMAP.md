...
**Plans**: 5 plans (0 of 5 complete)
  - [ ] 75-01-PLAN.md — Wave 0: git mv relocate Phase 64 microbench to internal/semantic/bench/ (atomic, INFRA-01/03)
  - [ ] 75-02-PLAN.md — Wave 1: six-dir bench/ skeleton + BENCH.md/PROVIDERS.md/LICENSES.md + eval cross-link + REQUIREMENTS v1→v2 (BENCH-01/06, INFRA-01/02/03)
...
|-------|----------------|--------|-----------|
| 75. Schema, Fairness Contract & Tree Skeleton | 0/5 | Planned | - |
