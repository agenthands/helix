...
- [ ] **v2.8 Graph Intelligence Depth (cbm-mcp parity)** -- Phases 121-123 (in progress) — see `.planning/milestones/v2.8-ROADMAP.md`

## Phases

**Current: v2.8 Graph Intelligence Depth (Phases 121–123)** — Workstream A: SEMANTICALLY_RELATED via Random Indexing. Full detail in `.planning/milestones/v2.8-ROADMAP.md`. Workstream B (true interprocedural DATA_FLOWS) is gated on the B0 design fork and not yet roadmapped.
