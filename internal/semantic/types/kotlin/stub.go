// Package kotlin implements the Phase 62 P05 Kotlin type-resolver stub.
//
// Per D-12 v1: Kotlin has no static type analyzer. The stub is LSP-conditional.
...
func (s *Stub) ResolveChain(ctx context.Context, req types.ChainRequest) (types.ChainResponse, error) {
	...
	return types.ChainResponse{
		...
		Source:          "stub.kotlin",
		Reason:          "kotlin: no LSP fact + no static analyzer in v1",
	}, nil
}
