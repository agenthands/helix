// Package php implements the Phase 62 P05 PHP type-resolver stub.
//
// Per D-12 v1: PHP has no LSP cascade and no static analyzer wired into
...
// phase will replace this stub with a full resolver (likely PHPDoc-driven).
//
...
// Stub is the PHP always-0.20 type-resolver stub.
type Stub struct{}

// NewStub constructs a PHP stub. Takes no EffectiveReader — D-12 invariant.
